(function (factory) {
	if (typeof define === "function" && define["amd"]) {
		define(["/js/lib/knockout-2.2.1.js"], factory);
	} else {
		factory(ko);
	}
}(function (ko, undefined) {
	var concerto = {};
	var concerto.koViewModel = function( identifier ) {
		var self = this;
	...
	var concerto.koPaginator = function( urlCallback ) {
		var self = this;
	...
	return { koViewModel: concerto.koViewModel, koPaginator: concerto.koPaginator };
}))//(this)